...
1. 不准在没有跑通 **所有已启用 module 的构建** 的情况下 commit
   ...
   - 当前阶段（W4 ② 后）：验证命令为 `go build ./pkg/... ./proto/... ./services/account/login/... ./services/runtime/push/... ./services/runtime/player_locator/... ./services/matchmaking/team/... ./services/matchmaking/matchmaker/... ./services/battle/ds_allocator/...`
